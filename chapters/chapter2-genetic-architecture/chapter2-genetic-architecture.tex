...
{ \Large \leftwatermark{
		\put(-84,-66.5){ 1 }
		\put(-97.5,-101){\includegraphics[scale=0.8]{img/thumbindex/thumbindex_LightBlue.eps}}  
		\put(-84,-91.5){ {\color{white} 2 }}
		\put(-84,-116.5){ 3 }
		\put(-84,-141.5){ 4 }
		\put(-84,-166.5){ 5 }
		\put(-84,-191.5){ 6 }
		...
		\put(417.5,-66.5){ 1 }
		\put(417.5,-101){\includegraphics[scale=0.8]{img/thumbindex/thumbindex_LightBlue.eps}}  
		\put(417.5,-91.5){ {\color{white} 2 }}
		\put(417.5,-116.5){ 3 }
		\put(417.5,-141.5){ 4 }
		\put(417.5,-166.5){ 5 }
		\put(417.5,-191.5){ 6 }

...
{ \Large \leftwatermark{
		\put(-67,-66.5){ 1 }
		\put(-67,-91.5){ 2 }
		\put(-76.5,-126){\includegraphics[scale=0.8]{img/thumbindex/thumbindex_LightOrange.eps}}  
		\put(-67,-116.5){ {\color{white} 3 }}
		\put(-67,-141.5){ 4 }
		\put(-67,-166.5){ 5 }
		\put(-67,-191.5){ 6 }
	} \rightwatermark{
		\put(350.5,-66.5){ 1 }
		\put(350.5,-91.5){ 2 }
		\put(346.5,-126){\includegraphics[scale=0.8]{img/thumbindex/thumbindex_LightOrange.eps}}  
		\put(350.5,-116.5){ {\color{white} 3 }}
		\put(350.5,-141.5){ 4 }
		\put(350.5,-166.5){ 5 }
		\put(350.5,-191.5){ 6 }
}}

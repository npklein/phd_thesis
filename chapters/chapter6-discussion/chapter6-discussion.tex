...
{ \Large \leftwatermark{
		...
		\put(-50,-141.5){ 4 }
		\put(-50,-166.5){ 5 }
		\put(-97.5,-201){\includegraphics[scale=0.8]{img/thumbindex/thumbindex_Grey.eps}} 
		\put(-50,-191.5){ {\color{white} 6 }}
	} \rightwatermark{
		\put(388,-66.5){ 1 }
		\put(388,-91.5){ 2 }
		\put(388,-116.5){ 3 }
		\put(388,-141.5){ 4 }
		\put(388,-166.5){ 5 }
		\put(380,-201){\includegraphics[scale=0.8]{img/thumbindex/thumbindex_Grey.eps}} 
		\put(388,-191.5){ {\color{white} 6 }}
}}
